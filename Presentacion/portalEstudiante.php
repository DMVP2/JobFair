                        ...
                        <div class="card card-profile">
                            ...
                            <div class="card-body">
                                ...
                                <h5> Documento: <?php echo $estudiante->getTipoDeDocumento() . " " . $estudiante->getNumeroDocumento() ?></h2>
                                    ...
                                    ?>
                                        <button type="submit" class="btn btn-primary" onclick="window.location.href='hojaVida.php'">Ver hoja de Vida</button>
                                        <button type="submit" class="btn btn-primary" onclick="window.location.href='hojaVida/registroHojaVida.php'">Actualizar hoja de Vida</button>
                                    <?php
                                    } else {
                                    ?>
                                        <button type="submit" class="btn btn-primary" onclick="window.location.href='hojaVida/registroHojaVida.php'">Crear hoja de vida</button>
                                    <?php
                                    }
                                    ?>
                                    <br>
