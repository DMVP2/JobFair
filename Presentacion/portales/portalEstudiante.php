                            ...
                            <div class="card-body">
                                ...
                                <h5> Documento:
                                    ...
                                    <button type="submit" class="btn btn-primary"
                                        onclick="window.location.href='<?php echo CARPETA_RAIZ . RUTA_EDITAR . 'editarEstudiante.php' ?>'">Actualizar
                                        información personal</button>

                                    <?php
                                    if (strcasecmp($hojaVida, "Si") == 0) {
                                    ?>
                                    <form action="<?php echo CARPETA_RAIZ . RUTA_INFORMACION . 'hojaVida.php' ?>"
                                        method="post">
                                    ...
                                    <form
                                        action="<?php echo CARPETA_RAIZ . RUTA_PRESENTACION . 'registroHojaVida.php' ?>"
                                        method="post">
                                        <input class="btn btn-primary" type="hidden"
                                            id=<?php echo "'" . $estudiante->getNumeroDocumento() . "'"; ?>
                                            name="idEstudiante"
