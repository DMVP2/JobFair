                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="alert alert-success" style="text-align: left"><strong> Programa
                                                    académico: </strong>
                                                <?php echo $estudiante->getProgramaAcademico() ?> </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="alert alert-warning" style="text-align: left"><strong>
                                                    Experiencia de la vacante: </strong>
                                                <?php echo $estudiante->getExperiencia() ?> </div>
                                            <?php
                                            } else {
                                            ?>
                                            <div class="alert alert-danger" style="text-align: left"><strong>
                                                    Experiencia: </strong> <?php echo $estudiante->getExperiencia() ?>
                                            </div>
                                            <?php
                                            }
                                            ?>
